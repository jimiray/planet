...
require 'newaccount_controller'

# Raise errors beyond the default web-based presentation
class NewaccountController; def rescue_action(e) raise e end; end

class NewaccountControllerTest < Test::Unit::TestCase
  
  fixtures :users
  
  def setup
    @controller = NewaccountController.new
