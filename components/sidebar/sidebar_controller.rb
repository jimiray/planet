class Sidebars::Plugin < ApplicationController
  ...
  def index
    ...
    content 
    render :action=>'content', :layout=>false unless performed?
  end
  ...
  def configure_wrapper
    ...
    configure
    render :action=>'configure', :layout=>false unless performed?
  end
...
module Sidebars
  class SidebarController < ApplicationController
    ...
    def self.enabled_sidebars
      ...
      SidebarConfig.find_all_visible.select do |sidebar|
